...
class SecondPageView(FloatLayout):
    def __init__(self, controller, **kwargs):
        FloatLayout.__init__(self, **kwargs)
        self.controller = controller
        self.label = Label()
        self.label.text = "Vous êtes sur la page 2"
        self.label.color = "#0984e3"
    ...
    def add_buttons(self):
        ...
        self.switch_to_third_page_button.bind(
            on_press=self.switch_to_third_page)
